...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/ADApp/Db/NDPluginBase.template","P=${P},R=${R}ADC_PM_A,PORT=ADC_PM_A_Array,ADDR=0,TIMEOUT=1,NDARRAY_PORT=$(PORT),NDARRAY_ADDR=48")
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/ADApp/Db/NDStdArrays.template", "P=${P},R=${R}ADC_PM_A,PORT=ADC_PM_A_Array,ADDR=0,TIMEOUT=1,TYPE=Int16,FTVL=SHORT,NELEMENTS=$(WAVEFORM_MAX_POINTS)")

NDStdArraysConfigure("ADC_PM_B_Array", $(QSIZE), 0, "$(PORT)", 49)
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/ADApp/Db/NDPluginBase.template","P=${P},R=${R}ADC_PM_B,PORT=ADC_PM_B_Array,ADDR=0,TIMEOUT=1,NDARRAY_PORT=$(PORT),NDARRAY_ADDR=49")
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/ADApp/Db/NDStdArrays.template", "P=${P},R=${R}ADC_PM_B,PORT=ADC_PM_B_Array,ADDR=0,TIMEOUT=1,TYPE=Int16,FTVL=SHORT,NELEMENTS=$(WAVEFORM_MAX_POINTS)")

NDStdArraysConfigure("ADC_PM_C_Array", $(QSIZE), 0, "$(PORT)", 50)
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/ADApp/Db/NDPluginBase.template","P=${P},R=${R}ADC_PM_C,PORT=ADC_PM_C_Array,ADDR=0,TIMEOUT=1,NDARRAY_PORT=$(PORT),NDARRAY_ADDR=50")
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/ADApp/Db/NDStdArrays.template", "P=${P},R=${R}ADC_PM_C,PORT=ADC_PM_C_Array,ADDR=0,TIMEOUT=1,TYPE=Int16,FTVL=SHORT,NELEMENTS=$(WAVEFORM_MAX_POINTS)")

NDStdArraysConfigure("ADC_PM_D_Array", $(QSIZE), 0, "$(PORT)", 51)
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/ADApp/Db/NDPluginBase.template","P=${P},R=${R}ADC_PM_D,PORT=ADC_PM_D_Array,ADDR=0,TIMEOUT=1,NDARRAY_PORT=$(PORT),NDARRAY_ADDR=51")
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/ADApp/Db/NDStdArrays.template", "P=${P},R=${R}ADC_PM_D,PORT=ADC_PM_D_Array,ADDR=0,TIMEOUT=1,TYPE=Int16,FTVL=SHORT,NELEMENTS=$(WAVEFORM_MAX_POINTS)")

NDStdArraysConfigure("ADC_PMAMP_Freq_Array", $(QSIZE), 0, "$(PORT)", 53)
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/ADApp/Db/NDPluginBase.template","P=${P},R=${R}ADC_PMAMP_Freq,PORT=ADC_PMAMP_Freq_Array,ADDR=0,TIMEOUT=1,NDARRAY_PORT=$(PORT),NDARRAY_ADDR=53")
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/ADApp/Db/NDStdArrays.template", "P=${P},R=${R}ADC_PMAMP_Freq,PORT=ADC_PMAMP_Freq_Array,ADDR=0,TIMEOUT=1,TYPE=Float64,FTVL=DOUBLE,NELEMENTS=$(WAVEFORM_MAX_POINTS)")
