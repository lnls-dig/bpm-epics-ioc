...
NDStdArraysConfigure("MONIT_FAKEQ_Array", $(QSIZE), 0, "$(PORT)", 40)
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDPluginBase.template","P=${P},R=${R}MONIT_FAKEQ,PORT=MONIT_FAKEQ_Array,ADDR=0,TIMEOUT=1,NDARRAY_PORT=$(PORT),NDARRAY_ADDR=40")
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDStdArrays.template", "P=${P},R=${R}MONIT_FAKEQ,PORT=MONIT_FAKEQ_Array,ADDR=0,TIMEOUT=1,NDARRAY_PORT=$(PORT),TYPE=Float64,FTVL=DOUBLE,NELEMENTS=1")

NDStdArraysConfigure("MONIT_FAKESUM_Array", $(QSIZE), 0, "$(PORT)", 41)
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDPluginBase.template","P=${P},R=${R}MONIT_FAKESUM,PORT=MONIT_FAKESUM_Array,ADDR=0,TIMEOUT=1,NDARRAY_PORT=$(PORT),NDARRAY_ADDR=41")
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDStdArrays.template", "P=${P},R=${R}MONIT_FAKESUM,PORT=MONIT_FAKESUM_Array,ADDR=0,TIMEOUT=1,NDARRAY_PORT=$(PORT),TYPE=Float64,FTVL=DOUBLE,NELEMENTS=1")
