...
NDTimeSeriesConfigure("STATSGEN_A_TS", $(QSIZE), 0, "STATSGEN_A", 0, 1)
...
NDTimeSeriesConfigure("STATSGEN_B_TS", $(QSIZE), 0, "STATSGEN_B", 1, 1)
...
NDTimeSeriesConfigure("STATSGEN_C_TS", $(QSIZE), 0, "STATSGEN_C", 2, 1)
...
NDTimeSeriesConfigure("STATSGEN_D_TS", $(QSIZE), 0, "STATSGEN_D", 3, 1)
...
NDTimeSeriesConfigure("STATSGEN_X_TS", $(QSIZE), 0, "STATSGEN_X", 6, 1)
...
NDTimeSeriesConfigure("STATSGEN_Y_TS", $(QSIZE), 0, "STATSGEN_Y", 7, 1)
...
NDTimeSeriesConfigure("STATSGEN_Q_TS", $(QSIZE), 0, "STATSGEN_Q", 8, 1)
...
NDTimeSeriesConfigure("STATSGEN_SUM_TS", $(QSIZE), 0, "STATSGEN_SUM", 9, 1)
...
NDTimeSeriesConfigure("STATSPM_A_TS", $(QSIZE), 0, "STATSPM_A", 12, 1)
...
NDTimeSeriesConfigure("STATSPM_B_TS", $(QSIZE), 0, "STATSPM_B", 13, 1)
...
NDTimeSeriesConfigure("STATSPM_C_TS", $(QSIZE), 0, "STATSPM_C", 14, 1)
...
NDTimeSeriesConfigure("STATSPM_D_TS", $(QSIZE), 0, "STATSPM_D", 15, 1)
...
NDTimeSeriesConfigure("STATSPM_X_TS", $(QSIZE), 0, "STATSPM_X", 18, 1)
...
NDTimeSeriesConfigure("STATSPM_Y_TS", $(QSIZE), 0, "STATSPM_Y", 19, 1)
...
NDTimeSeriesConfigure("STATSPM_Q_TS", $(QSIZE), 0, "STATSPM_Q", 20, 1)
...
NDTimeSeriesConfigure("STATSPM_SUM_TS", $(QSIZE), 0, "STATSPM_SUM", 21, 1)
...
NDTimeSeriesConfigure("STATSSP_A_TS", $(QSIZE), 0, "STATSSP_A", 24, 1)
...
NDTimeSeriesConfigure("STATSSP_B_TS", $(QSIZE), 0, "STATSSP_B", 25, 1)
...
NDTimeSeriesConfigure("STATSSP_C_TS", $(QSIZE), 0, "STATSSP_C", 26, 1)
...
NDTimeSeriesConfigure("STATSSP_D_TS", $(QSIZE), 0, "STATSSP_D", 27, 1)
