...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}GEN_A_TS_STATS, PORT=STATSGEN_A_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSGEN_A,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}GEN_B_TS_STATS, PORT=STATSGEN_B_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSGEN_B,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}GEN_C_TS_STATS, PORT=STATSGEN_C_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSGEN_C,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}GEN_D_TS_STATS, PORT=STATSGEN_D_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSGEN_D,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}GEN_X_TS_STATS, PORT=STATSGEN_X_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSGEN_X,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
# Alias
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}GEN_Y_TS_STATS, PORT=STATSGEN_Y_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSGEN_Y,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
# Alias
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}GEN_Q_TS_STATS, PORT=STATSGEN_Q_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSGEN_Q,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
# Alias
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}GEN_SUM_TS_STATS, PORT=STATSGEN_SUM_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSGEN_SUM,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
# Alias
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}PM_A_TS_STATS, PORT=STATSPM_A_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSPM_A,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}PM_B_TS_STATS, PORT=STATSPM_B_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSPM_B,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}PM_C_TS_STATS, PORT=STATSPM_C_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSPM_C,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}PM_D_TS_STATS, PORT=STATSPM_D_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSPM_D,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}PM_X_TS_STATS, PORT=STATSPM_X_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSPM_X,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}PM_Y_TS_STATS, PORT=STATSPM_Y_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSPM_Y,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}PM_Q_TS_STATS, PORT=STATSPM_Q_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSPM_Q,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}PM_SUM_TS_STATS, PORT=STATSPM_SUM_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSPM_SUM,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}SP_A_TS_STATS, PORT=STATSSP_A_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSSP_A,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}SP_B_TS_STATS, PORT=STATSSP_B_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSSP_B,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}SP_C_TS_STATS, PORT=STATSSP_C_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSSP_C,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
...
dbLoadRecords("$(AREA_DETECTOR_COMPAT)/db/NDTimeSeries.template",  "P=${P},R=${R}SP_D_TS_STATS, PORT=STATSSP_D_TS,ADDR=0,TIMEOUT=1,NDARRAY_PORT=STATSSP_D,NDARRAY_ADDR=1,NCHANS=$(NCHANS),ENABLED=1")
