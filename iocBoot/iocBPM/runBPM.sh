...
BOARD_IDX=$(/usr/share/halcs/generate-board-halcs-idx.sh ${BPM_NUMBER} | awk '{print $2}')
HALCS_IDX=$(/usr/share/halcs/generate-board-halcs-idx.sh ${BPM_NUMBER} | awk '{print $3}')
