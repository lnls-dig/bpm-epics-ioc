...
static long bpmPolyCalQProcessAsub(aSubRecord *prec)
{
    ...
    double coeffx1y7_q = in_coeff_q[3];
    double coeffx1y9_q = in_coeff_q[4];
    double coeffx3y1_q = in_coeff_q[5];
    double coeffx3y3_q = in_coeff_q[6];
    double coeffx3y5_q = in_coeff_q[7];
    double coeffx5y1_q = in_coeff_q[8];
    double coeffx5y3_q = in_coeff_q[9];
